...
public sealed class MainWindowViewModel : ViewModelBase, IDisposable
{
    ...
    public MainWindowViewModel()
    {
        ...
        {
            new("Auto (recommended)", "Auto", "Uses OBS if available, otherwise falls back automatically - also knows which games need Windows Capture due to anti-cheat and switches for you."),
